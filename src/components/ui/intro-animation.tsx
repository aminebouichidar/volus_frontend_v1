    ...
    return (
        ...
        >
            ...
            >
                {/* Front Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-neutral-800 border border-white/10"
                ...
                {/* Back Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-neutral-900 flex flex-col items-center justify-center p-4 border border-white/10"
...
export default function IntroAnimation() {
    ...
    // Happens in the first 15% of the scroll
    const morphProgress = useTransform(scrollYProgress, [0, 0.15], [0, 1]);
    const smoothMorph = useSpring(morphProgress, { stiffness: 40, damping: 20 });

    // 2. Scroll Rotation (Shuffling): Starts after morph
    // Rotates the bottom arc as user continues scrolling. Finishes at 80% to let the user admire the result.
    const scrollRotate = useTransform(scrollYProgress, [0.15, 0.8], [0, 360]);
    ...
    return (
        <div ref={containerRef} className="relative w-full h-[400vh] bg-transparent">
            <div className="sticky top-0 h-screen w-full overflow-hidden" ref={stickyRef}>
                {/* Container */}
                <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                    ...
                    <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                        ...
                        <motion.p
                            ...
                            className="mt-4 text-xs font-bold tracking-[0.2em] text-blue-400"
                        >
                            SCROLL TO EXPLORE
                        </motion.p>
                    </div>
